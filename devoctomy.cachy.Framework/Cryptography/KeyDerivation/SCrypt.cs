...
namespace devoctomy.cachy.Framework.Cryptography.KeyDerivation
{
    /// <summary>
    ...
    public class SCrypt
    {
        ...
        /// <param name="saltInBytes">Optional salt, null to generate automatically</param>
        /// <param name="saltOutBytes">Output, the salt that was used in the derivation process</param>
        /// <returns>The derived bytes</returns>
        public byte[] DeriveBytes(string password, byte[] saltInBytes, out byte[] saltOutBytes)
        {
